                        ...
                        <form @submit="formSubmitted">
                            <div class="form-row">
                                <div class='form-group col-md-6'>
                                    ...
                                    <input
                                        v-model.number='marker_position.lat'
                                        class='form-control'
                                        step="any"
                                ...
                                <div class='form-group col-md-6'>
                                    ...
                                    <input
                                        v-model.number='marker_position.lng'
                                        class='form-control'
                                        step="any"
                            ...
                            <div class="form-group">
                                <label for="old-image" class="image"> Gambar Lama: </label>
                               <a :href="`/site/image/${site.id}?`">
                                    <img
                                        style="width: 100%; height: 240px; object-fit: cover"
                                        :src="`/site/thumbnail/${site.id}?` + getTime()" :alt="site.point.name">
                               </a>
                            </div>
    ...
    export default {
        methods: {
            ...
            formSubmitted(event) {
                ...
                axios.post(`/site/update/${this.site.id}`, data, {headers: { 'Content-Type': 'multipart/form-data' }})
        ...
        data() {
            return {
                ...
                name: window.site.point.name,
                visitor_count: window.site.visitor_count,
                fee: window.site.fee,
                facility_count: window.site.facility_count,
                site_category_id: window.site.site_category_id,
                description: window.site.description
            }
        },

        computed: {
            site() { return window.site },
